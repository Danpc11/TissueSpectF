...
list(
  ...
  consensus = list(
    ...
    max_components = 50L,
    # Prevalence tiers for a condition's OWN invariants (condition_invariants_
    # <cond>.tsv): fraction of that condition's own samples where a component
    # stands out (prevalence_rank), with no requirement on phase or power --
